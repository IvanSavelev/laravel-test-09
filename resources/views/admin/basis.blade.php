...
@section('content_basis')
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route ('admin.index.form')}}">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ route ('admin.product.list')}}">Товары</a>
            <a class="collapse-item" href="{{ route ('admin.category.list')}}">Категории</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
        <div class="px-2 px-sm-2 px-md-2 px-lg-2 px-xl-2 ">
          @yield('content')
        </div>
      </div>
      <!-- End of Main Content -->
