...
@section('content')
  ...
  <div class="row">
    <div class="col-12">
      <form enctype="multipart/form-data" action="{{ route ('admin.contact.save') }}" method="POST">
        @csrf
        <div class="c-tabs">
        ...
        <div class="col-12">
          <div class="row c-invoice">
            <div class="col-12 u-p-small u-mr-auto">
              ...
              <button type="submit" data-type="update" class="c-btn c-btn--info">Сохранить и остаться на странице
              </button>
            </div>
          </div>
        </div>
