<div class="c-field u-mb-medium">
  ...
  <textarea class="c-input @if($errors->has($name))c-input--danger @endif" id="{{ $name }}" name="{{ $name }}">@if(isset($object) and isset($object->$name)){{ $object->$name }}@else{{ old($name) }}@endif</textarea>
  @if ($errors->has($name))
