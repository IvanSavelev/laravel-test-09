...
use Illuminate\Support\Arr as ArrRoot;

class Arr extends ArrRoot
{
    /**
	 ...
	 */
	public static function val($arr, $key, $type = '', $default = false)
	{
	 ...
	 * @return array
	 */
	public static function reindex(array $array, $key, $val = false, $group = false)
	{
		$res = array();
	...
	public static function replace_mask($string, $mask_array)
	{
